...
public class PdmXmlParserUtils {
    ...
    public static <T> List<T> buildTables(Element element, Class<T> entityClass) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        ...
        for (Element childElement : childrenElement) {
            ...
            for (Field field : fields) {
                ...
                Element attributeElement =
                        childElement.getChild(name,
                                ConfigNamespace.getNamespace(fieldAnnotation.value()));
                Object value = null;
                ...
                if (attributeElement != null) {
                    ...
                    if (!fieldAnnotation.isGroup()) {
                        ...
                        Class<?> groupClass = Class.forName(fieldType.getActualTypeArguments()[0].getTypeName());
                        //通过递归解析它子集合中的参数
